...
INSERT INTO tb_user (id, username, email, password, created_at, updated_at) VALUES (1, 'Ana', 'ana@gmail.com', '$2a$10$FQsz0mPod2ar9MwpayRX6./iKICBAX51bVFLKISoOOTXa0ZMdhFhO', now(), now());
INSERT INTO tb_user (id, username, email, password, created_at, updated_at) VALUES (2, 'Bob', 'bob@gmail.com', '$2a$10$FQsz0mPod2ar9MwpayRX6./iKICBAX51bVFLKISoOOTXa0ZMdhFhO', now(), now());
